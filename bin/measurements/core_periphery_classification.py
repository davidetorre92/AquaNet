...
columns_nodes = ['Network', 'Node ID', 'Node Name', 'Compartment Structure']
columns_size = ['Network', 'Core', 'IN set', 'OUT set', 'Tubes', 'Tendrils IN', 'Tendrils OUT', 'Disconnected set', 'Vertices count']
# Save
