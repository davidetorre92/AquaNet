...
available_graphs_real = df_tc_real['graph_name'].unique().tolist()
available_graphs_swap = df_tc_random['graph_name'].unique().tolist()
...
for graph_name in available_graphs:
    df_random_graph = df_tc_random[df_tc_random['graph_name'] == graph_name].iloc[:,2:]
    N_real = df_tc_real[df_tc_real['graph_name'] == graph_name].iloc[0,1:]
...
df_triad_representation.insert(0, 'graph_name', available_graphs)
